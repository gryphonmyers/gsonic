...
},{"array-each":2,"array-slice":3,"for-own":15,"isobject":20}],24:[function(require,module,exports){
...
},{"./src/runtime":27}],27:[function(require,module,exports){
(function (global){
...
},{"./create-element":33,"./dom-index":34,"./patch-op":35,"global/document":16,"x-is-array":75}],37:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/is-thunk":43,"../vnode/is-vhook":44,"../vnode/is-vnode":45,"../vnode/is-vtext":46,"../vnode/is-widget":47,"../vnode/vnode.js":49,"../vnode/vtext.js":51,"./hooks/ev-hook.js":38,"./hooks/soft-set-hook.js":39,"./parse-tag.js":41,"x-is-array":75}],41:[function(require,module,exports){
'use strict';
...
},{"browser-split":6}],42:[function(require,module,exports){
...
},{"../vnode/handle-thunk":42,"../vnode/is-thunk":43,"../vnode/is-vnode":45,"../vnode/is-vtext":46,"../vnode/is-widget":47,"../vnode/vpatch":50,"./diff-props":52,"x-is-array":75}],54:[function(require,module,exports){
module.exports = require('./src/presets/weddell-ro+vd');

},{"./src/presets/weddell-ro+vd":69}],55:[function(require,module,exports){
...
},{"./action-dispatcher":55,"./component":57,"./event-emitter-mixin":58,"./sig":60,"debounce":7,"document-ready-promise":11,"mixwith-es5":21,"object.defaults/immutable":22}],57:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var defaults = require('object.defaults/immutable');
...
},{"../utils/includes":73,"../utils/make-hash":74,"./event-emitter-mixin":58,"./sig":60,"mixwith-es5":21,"object.defaults/immutable":22}],58:[function(require,module,exports){
...
},{"../utils/includes":73,"mixwith-es5":21,"object.defaults/immutable":22}],59:[function(require,module,exports){
var EventEmitterMixin = require('./event-emitter-mixin');
var mix = require('mixwith-es5').mix;
...
},{"../utils/difference":71,"../utils/includes":73,"../utils/make-hash":74,"./event-emitter-mixin":58,"array-uniq":4,"deep-equal":8,"mixwith-es5":21,"object.defaults/immutable":22}],62:[function(require,module,exports){
class Transform {
    constructor(opts) {
        var Sig = this.constructor.Weddell.classes.Sig;
        this.func = opts.func;
...
},{"../utils/includes":73,"./app":56,"./component":57,"./pipeline":59,"./sig":60,"./store":61,"./transform":62,"mixwith-es5":21}],64:[function(require,module,exports){
var Mixin = require('mixwith-es5').Mixin;
var mix = require('mixwith-es5').mix;
...
},{"./machine-state-mixin":65,"./router":66,"./state-machine-mixin":67,"mixwith-es5":21}],65:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
...
},{"../../core/event-emitter-mixin":58,"mixwith-es5":21}],66:[function(require,module,exports){
var defaults = require('object.defaults/immutable');
...
},{"array-compact":1,"find-parent":13,"object.defaults/immutable":22,"path-to-regexp":24}],67:[function(require,module,exports){
var mix = require('mixwith-es5').mix;
var EventEmitterMixin = require('../../core/event-emitter-mixin');
var DeDupe = require('mixwith-es5').DeDupe;
...
},{"../../core/event-emitter-mixin":58,"./machine-state-mixin":65,"mixwith-es5":21}],68:[function(require,module,exports){
...
},{"../../utils/flatmap":72,"array-compact":1,"mixwith-es5":21,"object.defaults/immutable":22,"virtual-dom/create-element":28,"virtual-dom/diff":29,"virtual-dom/h":30,"virtual-dom/patch":31,"virtual-dom/vnode/vnode":49}],69:[function(require,module,exports){
module.exports = require('../plugins/vdom')(
    require('../plugins/router')(require('./weddell'))
);

},{"../plugins/router":64,"../plugins/vdom":68,"./weddell":70}],70:[function(require,module,exports){
module.exports = require('../core/weddell');

},{"../core/weddell":63}],71:[function(require,module,exports){
...
},{"./index.css":76,"./index.pug":78}],78:[function(require,module,exports){
require('pug-vdom/runtime');
 module.exports = function(locals, h){function render(context, h) {
  ...
  var n4Child = []
  var n5Child = []
  var props = {attributes: runtime.compileAttrs([{name:'type', val: "text"},{name:'id', val: "auth-server"}], [])};
  if (props.attributes.id) props.key = props.attributes.id;
  var n5 = h('input', props, n5Child)
  n4Child.push(n5)
  var n6Child = []
  var props = {attributes: runtime.compileAttrs([{name:'type', val: "text"},{name:'id', val: "auth-user"}], [])};
  if (props.attributes.id) props.key = props.attributes.id;
  var n6 = h('input', props, n6Child)
  n4Child.push(n6)
  var n7Child = []
  var props = {attributes: runtime.compileAttrs([{name:'type', val: "password"},{name:'id', val: "auth-password"}], [])};
  if (props.attributes.id) props.key = props.attributes.id;
  ...
  if (props.attributes.id) props.key = props.attributes.id;
  var n8 = h('submit', props, n8Child)
  n4Child.push(n8)
  var props = {attributes: runtime.compileAttrs([{name:'class', val: 'auth-form'},{name:'onsubmit', val: locals.$bind("this.submitForm(event.target)", {preventDefault: true})}], [])};
  if (props.attributes.id) props.key = props.attributes.id;
  var n4 = h('form', props, n4Child)
  n0Child.push(n4)
  return n0Child
}
return render(locals, h);}
},{"pug-vdom/runtime":26}],79:[function(require,module,exports){
...
},{"./index.css":79,"./index.pug":81}],81:[function(require,module,exports){
require('pug-vdom/runtime');
 module.exports = function(locals, h){function render(context, h) {
  if (!pugVDOMRuntime) throw "pug-vdom runtime not found.";
  var runtime = pugVDOMRuntime
  ...
  var n3Child = []
  n3Child.push("test")
  var props = {attributes: runtime.compileAttrs([{name:'class', val: 'my-element'}], [])};
  if (props.attributes.id) props.key = props.attributes.id;
...
return render(locals, h);}
},{"pug-vdom/runtime":26}],82:[function(require,module,exports){
arguments[4][76][0].apply(exports,arguments)
...
},{"../../scripts/routes":86,"./components/auth-form":77,"./components/library":80,"./index.css":82,"./index.pug":84}],84:[function(require,module,exports){
require('pug-vdom/runtime');
 module.exports = function(locals, h){function render(context, h) {
  if (!pugVDOMRuntime) throw "pug-vdom runtime not found.";
  var runtime = pugVDOMRuntime
  ...
  if(token) {
    var n1Child = []
    var props = {attributes: runtime.compileAttrs([{name:'token', val: token}], [])};
    if (props.attributes.id) props.key = props.attributes.id;
    var n1 = h('RouterView', props, n1Child)
    n0Child.push(n1)
  } else {
    var n2Child = []
    var props = {attributes: runtime.compileAttrs([], [])};
    if (props.attributes.id) props.key = props.attributes.id;
    var n2 = h('AuthForm', props, n2Child)
    n0Child.push(n2)
  }
  return n0Child
}
return render(locals, h);}
},{"pug-vdom/runtime":26}],85:[function(require,module,exports){
...
},{"../components/root":83,"weddell":54}],86:[function(require,module,exports){
module.exports = [
    {
        name: 'home',
        pattern: '/',
